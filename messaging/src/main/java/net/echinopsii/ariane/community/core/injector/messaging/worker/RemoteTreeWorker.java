...
public class RemoteTreeWorker implements AppMsgWorker {
    private static final Logger log = LoggerFactory.getLogger(RemoteTreeWorker.class);

    @Override
    public Map<String, Object> apply(Map<String, Object> message) {
        log.debug("Remote Injector Tree Worker on  : {" + message.get(MomMsgTranslator.MSG_APPLICATION_ID) +  " }...");
        //TODO WORK
        log.debug("Remote Injector Tree Worker return DONE");
