...
class cuInjectorGearsCacheProcessor(AConfUnit):
    ...
    def __init__(self, targetConfDir):
        ...
        self.confTemplatePath = os.path.abspath("resources/templates/components/infinispan.injector.gears.cache.xml.tpl")
        self.confFinalPath = targetConfDir + "infinispan.injector.gears.cache.xml"
        injectorSharedGearsCacheDir = cpInjectorSharedGearsCacheDir()
        self.paramsDictionary = {
            injectorSharedGearsCacheDir.name: injectorSharedGearsCacheDir
        }