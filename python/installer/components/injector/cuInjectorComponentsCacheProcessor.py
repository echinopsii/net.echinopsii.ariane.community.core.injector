...
class cuInjectorComponentsCacheProcessor(AConfUnit):
    ...
    def __init__(self, targetConfDir):
        ...
        self.confTemplatePath = os.path.abspath("resources/templates/components/infinispan.injector.components.cache.xml.tpl")
        self.confFinalPath = targetConfDir + "infinispan.injector.components.cache.xml"
        injectorSharedComponentsCacheDir = cpInjectorSharedComponentsCacheDir()
        self.paramsDictionary = {
            injectorSharedComponentsCacheDir.name: injectorSharedComponentsCacheDir
        }